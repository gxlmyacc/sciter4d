...
const
  CWFlags_Sizeable = [swTitlebar, swResizeable, swSysMenu, swMinimizeBox, swMaximizeBox, swAcceptFiles, swUxTheme];
  CWFlags_Dialog   = [swTitlebar, swMinimizeBox, swPopup, swAcceptFiles, swUxTheme];
  CWFlags_ToolWnd  = [swTool, swMinimizeBox, swPopup, swAcceptFiles, swUxTheme];
  CWFlags_None     = [swPopup, swMinimizeBox, swAcceptFiles, swUxTheme];
...
type
  ...
  CTL_TYPE = (
    ...
    CTL_HTMLAREA = 12,         ///< WYSIWYG HTML editor.
